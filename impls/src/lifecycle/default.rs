...
use crate::config::{
	config, GlobalWalletConfig, GlobalWalletConfigMembers, TorConfig, WalletConfig, MUGLE_WALLET_DIR,
};
...
use mugle_wallet_util::mugle_util::logger::LoggingConfig;
use std::fs;
	...
	K: Keychain + 'a,
{
	...
	fn create_config(
		...
		data_dir_name.push(MUGLE_WALLET_DIR);
