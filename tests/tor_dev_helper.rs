...
#[ignore]
#[test]
fn socks_tor() -> Result<(), mugle_wallet_controller::Error> {
	...
	// bound to the listening port 56815. By default, tor will also be running
	// a socks proxy lister at 127.0.0.1 9050 (both wallets can use for now)
	//
	// Relevant torrc config:
	// HiddenServiceDir ./hidden_service/
	// HiddenServicePort 80 127.0.0.1:56815
	//
	// tor -f torrc
	...
	let arg_vec = vec!["mugle-wallet", "-p", "password", "listen"];
