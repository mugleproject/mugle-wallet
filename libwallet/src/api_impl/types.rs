...
use crate::mugle_core::core::Output;
...
/// Type for storing amounts (in nanomugles).
...
pub struct InitTxArgs {
	...
	/// [`set_active_account`](../mugle_wallet_api/owner/struct.Owner.html#method.set_active_account) method.
	pub src_acct_name: Option<String>,
	#[serde(with = "secp_ser::string_or_u64")]
	/// The amount to send, in nanomugles. (`1 G = 1_000_000_000nG`)
	pub amount: u64,
	#[serde(with = "secp_ser::string_or_u64")]
...
pub struct IssueInvoiceTxArgs {
	...
	/// The invoice amount in nanomugles. (`1 G = 1_000_000_000nG`)
	#[serde(with = "secp_ser::string_or_u64")]
	pub amount: u64,
	/// Optionally set the output target slate version (acceptable
	/// down to the minimum slate version compatible with the current. If `None` the slate
