// Copyright 2021 The Mugle Develope;
//
...
use crate::mugle_core::core::hash::Hashed;
use crate::mugle_core::core::{Output, OutputFeatures, Transaction};
use crate::mugle_core::libtx::proof;
use crate::mugle_keychain::ViewKey;
use crate::mugle_util::secp::key::SecretKey;
use crate::mugle_util::Mutex;
use crate::mugle_util::ToHex;
use crate::util::{OnionV3Address, OnionV3AddressError};

use crate::api_impl::owner_updater::StatusMessage;
use crate::mugle_keychain::{BlindingFactor, Identifier, Keychain, SwitchCommitmentType};
	...
	K: Keychain + 'a,
{
	if !update_wallet_state(
		...
		return Err(ErrorKind::TransactionCancellationError(
			"Can't contact running Mugle node. Not Cancelling.",
		)
		.into());
	}
	wallet_lock!(wallet_inst, w);
...
/// get stored tx
/// crashes if stored tx has total fees exceeding 2^40 nanomugle
