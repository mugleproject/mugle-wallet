...
use crate::mugle_core::core::hash::Hash;
use crate::mugle_core::core::FeeFields;
use crate::mugle_core::core::{Output, Transaction, TxKernel};
use crate::mugle_core::libtx::{aggsig, secp_ser};
use crate::mugle_core::{global, ser};
use crate::mugle_keychain::{Identifier, Keychain};
use crate::mugle_util::logger::LoggingConfig;
use crate::mugle_util::secp::key::{PublicKey, SecretKey};
use crate::mugle_util::secp::{self, pedersen, Secp256k1};
use crate::mugle_util::{ToHex, ZeroingString};
	...
	K: Keychain + 'a,
{
	...
	/// default is assumed to be ~/.mugle/main/wallet_data (or testnet equivalent)
	...
	/// Output a mugle-wallet.toml file into the current top-level system wallet directory
	fn create_config(
		&self,
...
pub trait NodeClient: Send + Sync + Clone {
	...
	/// Posts a transaction to a mugle node
	...
	/// retrieves the current tip (height, hash) from the specified mugle node
	...
	/// retrieve a list of outputs from the specified mugle node
