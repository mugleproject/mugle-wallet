...
//! Contains V4 of the slate (mugle-wallet 4.0.0)
//! Changes from V3:
...
use crate::mugle_core::core::{Input, Output, TxKernel};
use crate::mugle_core::libtx::secp_ser;
use crate::mugle_keychain::{BlindingFactor, Identifier};
...
pub struct VersionCompatInfoV4 {
	...
	pub version: u16,
	/// Version of mugle block header this slate is compatible with
