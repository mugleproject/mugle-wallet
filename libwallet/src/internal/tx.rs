...
use crate::mugle_core::consensus::valid_header_version;
use crate::mugle_core::core::HeaderVersion;
use crate::mugle_keychain::{Identifier, Keychain};
use crate::mugle_util::secp::key::SecretKey;
use crate::mugle_util::secp::pedersen;
...
use mugle_wallet_util::mugle_core::core::FeeFields;
...
mod test {
	...
	use crate::mugle_core::core::{FeeFields, KernelFeatures};
	use crate::mugle_core::libtx::{build, ProofBuilder};
