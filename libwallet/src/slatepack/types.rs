...
use crate::dalek_ser;
use crate::mugle_core::ser::{self, Readable, Reader, Writeable, Writer};
use crate::{Error, ErrorKind};
use mugle_wallet_util::byte_ser;
...
#[test]
fn slatepack_bin_basic_ser() -> Result<(), mugle_wallet_util::byte_ser::Error> {
	use mugle_wallet_util::byte_ser;
...
#[test]
fn slatepack_bin_opt_fields_ser() -> Result<(), mugle_wallet_util::byte_ser::Error> {
...
#[test]
fn slatepack_bin_future() -> Result<(), mugle_wallet_util::byte_ser::Error> {
	use crate::mugle_core::global;
	use byteorder::{BigEndian, ReadBytesExt, WriteBytesExt};
	use mugle_wallet_util::byte_ser;
