...
pub trait OwnerRpc {
	...
	```
	# mugle_wallet_api::doctest_helper_json_rpc_owner_assert_response!(
	# r#"
	{
		"jsonrpc": "2.0",
		"method": "accounts",
		...
		# r#"
		{
			...
			"params": {
				...
				"args": {
					...
					"payment_proof_recipient_address": "tmugle1xtxavwfgs48ckf3gk8wwgcndmn0nt4tvkl8a7ltyejjcy2mc6nfs9gm2lp",
					"ttl_blocks": null,
					"send_args": null
				}
			},
	...
	*/
	...
	# r#"
	{
		...
		"jsonrpc": "2.0",
		"result": {
			"Ok": "tmugle1xtxavwfgs48ckf3gk8wwgcndmn0nt4tvkl8a7ltyejjcy2mc6nfs9gm2lp"
		}
	}
	# "#
	# , 0, false, false, false, false);
	...
	# r#"
	{
		...
		"result": {
			"Ok": {
				...
				"sender": "tmugle1xtxavwfgs48ckf3gk8wwgcndmn0nt4tvkl8a7ltyejjcy2mc6nfs9gm2lp",
				"slatepack": "1.0"
			}
		}
	}
	...
	# r#"
	{
		...
		"result": {
			"Ok": {
				...
				"recipient_address": "tmugle10qlk22rxjap2ny8qltc2tl996kenxr3hhwuu6hrzs6tdq08yaqgqq6t83r",
				...
				"sender_address": "tmugle1xtxavwfgs48ckf3gk8wwgcndmn0nt4tvkl8a7ltyejjcy2mc6nfs9gm2lp",
...
pub fn run_doctest_owner(
	...
	use mugle_wallet_libwallet::{api_impl, WalletInst};
...
macro_rules! doctest_helper_json_rpc_owner_assert_response {
	($request:expr, $expected_response:expr, $blocks_to_mine:expr, $perform_tx:expr, $lock_tx:expr, $finalize_tx:expr, $payment_proof:expr) => {
		...
		{
			use mugle_wallet_api::run_doctest_owner;
			use serde_json;
