	...
	K: Keychain + 'a,
{
	...
	/// None
	/// # Returns
	/// * [`VersionInfo`](../mugle_wallet_libwallet/api_impl/types/struct.VersionInfo.html)
	/// # Example
	/// Set up as in [`new`](struct.Foreign.html#method.new) method above.
	/// ```
	/// # mugle_wallet_api::doctest_helper_setup_doc_env_foreign!(wallet, wallet_config);
	///
	...
	/// is set to `Unsent` and a [Transaction Log Entry](../mugle_wallet_libwallet/types/struct.TxLogEntry.html)
	/// will be created. Note the output will be unspendable until the coinbase maturity period
	/// has expired.
	///
	/// # Arguments
	///
	/// * `block_fees` - A [`BlockFees`](../mugle_wallet_libwallet/api_impl/types/struct.BlockFees.html)
	...
	///
	/// # Returns
	/// * `Ok`([`cb_data`](../mugle_wallet_libwallet/api_impl/types/struct.CbData.html)`)` if successful. This
	...
	/// [`Slate`](../mugle_wallet_libwallet/slate/struct.Slate.html) object, modified with
	...
	///
	/// Also creates a corresponding [Transaction Log Entry](../mugle_wallet_libwallet/types/struct.TxLogEntry.html)
	/// in the wallet's transaction log.
	///
	/// # Arguments
	/// * `slate` - The transaction [`Slate`](../mugle_wallet_libwallet/slate/struct.Slate.html).
